...
- **Crawler** — rastreo interno que sigue los enlaces que descubre (BFS) respetando `robots.txt`: errores HTTP, titles y descriptions duplicados, thin content y enlaces internos rotos.
